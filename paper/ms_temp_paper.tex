...
Observations in SDO record the entire lifetime of the feature, however the same is not true for observations using the SST, where the observation window in SST closes at 07:48:00.\begin{pycode}[Onset]
import numpy as np
import sunpy.map
import matplotlib.pyplot as plt
