...
With its higher resolution, a slit based analysis of the jet can be observed in 
...
fig = plt.figure()
plt.imshow(np.rot90(data[3]), , cmap='cubehelix', aspect='auto')
plt.xlabel('Time in SST cadence (7.7 s)')
plt.ylabel('Distance along the slit')
sst_slit_fig = manager.save_figure('sst-slit', fig)
sst_slit_fig.figure_width = \columnwidth
sst_slit_fig.caption = 'CRISP/SST H alpha core line slit analysis.'
\end{pycode}
