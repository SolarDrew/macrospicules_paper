...
The dopplergrams demonstrated in \cref{fig:dop_grid}
Applying the method described above, we obtain dopplergrams of the feature when applied to the spectroscopic data produced by CRISP, presented in \cref{fig:dop_grid}.
