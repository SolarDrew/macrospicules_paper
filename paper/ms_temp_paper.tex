...
One method for testing whether jets have any effect on the atmosphere, is to inspect the temperature and surrounding environment. 
The tool we use to inspect this is the method highlighted in \cite{Leonard2014}. 
