...
% will need to rewrite this at a later date
...
An examination of the dopplergrams reveals little in the way of rotational behaviour, however the second event demonstrates a characteristic division of red and blue.
...
dop_frames = [76,77,78,79,80,81,82,83,84]
...
The dopplergrams demonstrated in \cref{fig:Dop_Exam}
Applying the method described above, we obtain dopplergrams of the feature when applied to the spectroscopic data produced by CRISP, presented in \cref{fig:Dop_Exam}.
The immediately apparent when we examine the data is the difficulty in clearly identifying the jet, with the complex background demonstrating shifts in both directions.
This is due top the effect of observing along the limb, we see features further round the disk as bulk motions.
The jet we are examining, apparently originates in a 'bank' of spicules, visible as lines of red shift in the image.
The initial acceleration of the spicule at $07:30$ shows no rotational motion and is infact hard to differentiate from the background.
However, the second jet formation and consequent acceleration reveal significant rotational motion.

As the onset occurs we first observe blue shifting on the right side of the jet
