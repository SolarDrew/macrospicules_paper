...
We have utilised a Markov Chain Monte Carlo (MCMC) method to find the most accurate fit for the  and the Bayesian Information Criterion (BIC) to test which of the two fits is most appropriate from a given line as a solution to this problem.
