...
lfig = manager.save_figure('sunpy1', fig)
...
Look the sun is in \cref{fig:sunpy1}.
...
As a solution to this problem we have utilised a Markov Chain Monte Carlo (MCMC) method to find the most accurate fit and the Bayesian Information Criterion (BIC) to test which of the two fits is most appropriate from a given line. 
